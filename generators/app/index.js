...
module.exports = class extends Generator {
    ...
    const prompts = [
      {
        type: 'input',
        name: 'name',
        message: 'Enter a module name, lower case only, with dashes as separators:',
  ...
  install() {
    ...
    this.module_json.packs.forEach(pack => {
      fs.writeFileSync(`${this.props.name}/${pack.path}`,'');
    });
    fs.writeFileSync(`${this.props.name}/module.json`, JSON.stringify(this.module_json, undefined, 2));
    console.log(this.module_json);
  }
};